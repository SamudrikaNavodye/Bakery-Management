...
public class signup_user extends AppCompatActivity {
    ...
    EditText etname, etpassword, etcompasssword, etemail, etmobileno, etusertype;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etusertype = findViewById(R.id.userType);
        ...
        btnsignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(username.isEmpty() || password.isEmpty() || compasword.isEmpty() || email.isEmpty() || mobileNo.isEmpty() || usertype.isEmpty() )
                {
                    Toast.makeText(getApplicationContext(),"One of the inputs are Empty. Please check and Try Again!" , Toast.LENGTH_LONG).show();
                }
